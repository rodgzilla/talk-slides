...
\begin{frame}
  ...
  What adversarial samples can be used for besides this?
  ...
  \begin{itemize}
  \item Exploring the biases of a neural network
  \item Create an harder task for semi-supervised learning
  \end{itemize}

...
\begin{frame}
  ...
  \begin{overprint}
    ...
    \only<4>{
      Make the task of a student harder in a semi-supervised learning setup.
    }

    %% \begin{itemize}
    %%   \onslide<3->{\item Exploring the biases of a neural network}
    %%   \onslide<4->{\item Create an harder task for semi-supervised learning}
    %% \end{itemize}
  \end{overprint}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{tikzpicture}[xscale = 3]
  ...
  \uncover<2> {
    ...
    \draw[->, thick] (neurons) -- (N11);
    \draw[->, thick] (neurons) -- (N12);
    \draw[->, thick] (neurons) -- (N13);
  }

  \uncover<3->{
    \path [ultra thick, draw, blue] (-0.25, 1) -- (0.25, 1) rectangle (-0.25, -9) -- (0.25, -9);

    \node[blue] (inputs) at (0, -9.5) {
      Input layer
    };
  }

  \uncover<4->{
    \path [ultra thick, draw, green] (2.75, -2.5) -- (3.25, -2.5) rectangle (2.75, -5.5) -- (3.25, -5.5);
    
    \node[green] (outputs) at (3, -6) {
      Output layer
    };
  }

  \uncover<5->{
    \path [ultra thick, draw, purple] (0.75, 1) -- (2.25, 1) rectangle (0.75, -9) -- (2.25, -9);

    \node[purple] (inputs) at (1.5, -9.5) {
      Hidden layers
    };
  }
\end{tikzpicture}

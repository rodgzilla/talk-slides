...
\begin{frame}
  ...
  Once decided on a model, a very effective sequence of actions is the
  following one:
  ...
  \begin{enumerate}
    ...
    \item Try to find a pre-trained version of this model that
      performs a related task (\emph{transfer learning})

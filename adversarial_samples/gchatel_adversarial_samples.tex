...
\begin{frame}
  ...
  at the target model $M$.

  \bigskip

  Once trained, we can create an adversarial sample $x'$ for the $M'$
  model and experience have shown that $x'$ will also fool $M$ very
  often.

  \bigskip

  What if we do not have a training set for the target network? Well\dots{} build one.
  ...
  - Papernot et al., about the attack on the MetaMind deep neural
  network.

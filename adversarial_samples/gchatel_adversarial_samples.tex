...
\begin{frame}
  ...
  \[
  \frac{\mathrm{d}L}{\mathrm{d}a} = 2 x (ax + b - y) \qquad \qquad
  \frac{\mathrm{d}L}{\mathrm{d}b} = 2 (ax + b - y)
  \]
...
\begin{frame}
  ...
  We can generate adversarial samples, and train the network to
  ...
  \item \textcolor{red}{Does not defend more complicated white box
